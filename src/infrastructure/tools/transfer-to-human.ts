...
export class TransferToHumanTool implements AgentTool {
  ...
  description =
    "Transfere a conversa para um atendente humano. Use quando o cliente pedir explicitamente por uma pessoa/atendente, " +
    "ou quando o prompt da organização definir situações de handoff.";
