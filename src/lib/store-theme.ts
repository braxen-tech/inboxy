...
export const STORE_THEME_PRESETS: StoreThemePreset[] = [
  {
    ...
    theme: { colorScheme: "light", primaryColor: "#6366f1", backgroundColor: "#ffffff", cardColor: "#f8f9fa", textColor: "#1a1a2e", fontFamily: "geist", borderRadius: "lg", cardLayout: "horizontal", coverImageUrl: null },
  },
  {
    id: "dark-pro",
    name: "Dark Pro",
    description: "Escuro e sofisticado — tech, SaaS, programação",
    theme: { colorScheme: "dark", primaryColor: "#a78bfa", backgroundColor: "#0f0f0f", cardColor: "#1a1a1a", textColor: "#e5e7eb", fontFamily: "geist", borderRadius: "md", cardLayout: "vertical", coverImageUrl: null },
  },
  {
    id: "creator",
    name: "Creator",
    description: "Vibrante e moderno — criadores de conteúdo",
    theme: { colorScheme: "light", primaryColor: "#a855f7", backgroundColor: "#fdf4ff", cardColor: "#f3e8ff", textColor: "#1e0a2e", fontFamily: "poppins", borderRadius: "full", cardLayout: "horizontal", coverImageUrl: null },
  },
  {
    id: "educator",
    name: "Educator",
    description: "Profissional e confiável — cursos e mentorias",
    theme: { colorScheme: "light", primaryColor: "#3b82f6", backgroundColor: "#eff6ff", cardColor: "#dbeafe", textColor: "#1e3a5f", fontFamily: "inter", borderRadius: "lg", cardLayout: "vertical", coverImageUrl: null },
  },
  {
    id: "premium",
    name: "Premium",
    description: "Quente e exclusivo — alto ticket, luxo",
    theme: { colorScheme: "dark", primaryColor: "#f59e0b", backgroundColor: "#1c1917", cardColor: "#292524", textColor: "#fef3c7", fontFamily: "playfair", borderRadius: "md", cardLayout: "horizontal", coverImageUrl: null },
  },
  {
    id: "fresh",
    name: "Fresh",
    description: "Natural e acolhedor — saúde, bem-estar, educação",
    theme: { colorScheme: "light", primaryColor: "#16a34a", backgroundColor: "#f0fdf4", cardColor: "#dcfce7", textColor: "#14532d", fontFamily: "poppins", borderRadius: "full", cardLayout: "horizontal", coverImageUrl: null },
  },
  {
    id: "tech-blue",
    name: "Tech Blue",
    description: "Navy + ciano — marketing digital, infoprodutores tech",
    theme: { colorScheme: "dark", primaryColor: "#22d3ee", backgroundColor: "#080d1a", cardColor: "#0f1a2e", textColor: "#e2e8f0", fontFamily: "geist", borderRadius: "md", cardLayout: "horizontal", coverImageUrl: null },
  },
  {
    id: "sport-gold",
    name: "Sport Gold",
    description: "Charcoal + dourado — fitness, esporte, alta performance",
    theme: { colorScheme: "dark", primaryColor: "#d4af37", backgroundColor: "#0c1118", cardColor: "#1a2033", textColor: "#f5f5f0", fontFamily: "playfair", borderRadius: "sm", cardLayout: "vertical", coverImageUrl: null },
  },
];
